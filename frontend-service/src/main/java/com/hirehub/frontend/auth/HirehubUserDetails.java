...
public class HirehubUserDetails implements UserDetails {
    ...
    public HirehubUserDetails(FrontendUserAccount user) {
        this.id = user.getId();
        ...
        this.verificationStatus = user.getVerificationStatus() == null ? null : user.getVerificationStatus().name();
