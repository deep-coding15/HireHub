package com.hirehub.event.consumer;
...
import com.hirehub.event.feign.NotificationServiceClientAPI;
...
public class QueueConsumer {
    ...
    @Autowired
    private final NotificationServiceClientAPI notificationClientAPI;
    ...
    public void handleCandidatureCreated(@Payload String message) {
        try {
            ...
            Long candidatureId = jsonNode.get("candidatureId").asLong();
            ...
            // Envoyer l'email
            notificationClientAPI.sendCandidatureConfirmation(new CandidatureDTO(candidatureId, candidatEmail, candidatName, offreTitle, offreId));
    ...
    public void handleStatutChanged(@Payload String message) {
        try {
            ...
            // Envoyer l'email de event
            notificationClientAPI.sendStatutChangedNotification(new CandidatureChangedDTO(candidatureId, candidatEmail, candidatName, offreTitle, ancienStatut, nouveauStatut, commentaire));

            log.info("[✅ STATUT] Email de event envoyé à: {} | Nouveau statut: {}",
    ...
    public void handleEntretienPlanifie(@Payload String message) {
        try {
            ...
            notificationClientAPI.sendEntretienPlanification(new EntretienPlanifiedDTO(candidatEmail, candidatName, offreTitle, dateEntretien, lieu, interviewerName));
    ...
    public void handleRecruiterDecision(@Payload String message) {
        try {
            ...
            // Envoyer l'email
            notificationClientAPI.sendHtmlEmail(new HtmlContentDTO(email, subject, body));
     ...
     * Action: Audit ou event administrative
     */
    ...
    public void handleAdminUserAction(@Payload String message) {
        try {
            ...
            log.info("[✅ ADMIN ACTION] Audit/event traitée");
        } catch (Exception e) {
