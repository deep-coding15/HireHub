package com.hirehub.event.publisher;
...
public class EventPublisherFirst {
     ...
     * Destination: event-service (via queue notif.candidature.queue)
     *
     ...
     * Source: candidature-service
     * Destination: event-service (via queue notif.statut.queue)
     *
     ...
     * Destination: event-service (via queue notif.entretien.queue)
     *
     ...
     * Destination: event-service (via queue notif.recruiter.queue)
     *
